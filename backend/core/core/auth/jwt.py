...
Uses the stdlib for password hashing (PBKDF2-HMAC-SHA256) so deployments do
not need native bcrypt wheels. Tokens are HS256 JWTs via PyJWT.
"""
...
def create_access_token(
    *,
    ...
    role_values = [
        r.value if isinstance(r, Role) else str(r) for r in roles
    ]
