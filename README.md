...
Monorepo for the MMS frontend (React / Vite) and FastAPI backend.
...
```
MMS/
├── frontend/            # React / Vite UI (Port 3000) - See frontend/README.md
...
|---|---|---|---|---|
| **Local** | `http://localhost:3000` | `http://localhost:8000` | `D:/MISO/MMS/` | `localhost:1521/FREEPDB1` (user/schema: `MMS`) |
